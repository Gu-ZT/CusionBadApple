...
execute if score $render gugle_badapple matches 1848 run function gugle:frame/1848
execute if score $render gugle_badapple matches 1849 run function gugle:frame/1849
