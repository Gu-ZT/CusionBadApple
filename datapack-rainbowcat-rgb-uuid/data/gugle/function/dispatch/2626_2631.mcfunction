execute if score $render gugle_badapple matches 2626 run function gugle:frame/2626
execute if score $render gugle_badapple matches 2627 run function gugle:frame/2627
execute if score $render gugle_badapple matches 2628 run function gugle:frame/2628
