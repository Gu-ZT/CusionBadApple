...
const messages = {
    "zh-CN": {
        ...
        threshold: "黑白阈值", invalidClip: "结束时间必须大于开始时间。", noFile: "请先选择视频或图片文件。",
    ...
    "en-US": {
        ...
        threshold: "B/W threshold", invalidClip: "End time must be greater than start time.", noFile: "Choose a video or image first.",
